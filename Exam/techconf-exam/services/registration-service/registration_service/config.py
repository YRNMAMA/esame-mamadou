...
class Config:
    ...
    def __init__(self):
        ...
        self.user_service_url = os.environ.get("USER_SERVICE_URL", "http://localhost:5001")
        self.event_service_url = os.environ.get("EVENT_SERVICE_URL", "http://localhost:5002")

        # Service URLs for inter-service communication
        self.registration_service_url = os.environ.get("REGISTRATION_SERVICE_URL", f"http://localhost:{self.port}")
